      ...
      html: `
        <div style="font-family: Arial, sans-serif; max-width: 700px; margin: 0 auto; background: #0f172a;">
          ...
          <div style="padding: 30px; color: #e2e8f0;">
            ...
            ${data.betSlipLink ? `
            <!-- Bet Slip Link -->
            <div style="text-align: center; margin: 20px 0; padding: 20px; background: rgba(16, 185, 129, 0.1); border-radius: 8px;">
              <p style="margin: 0 0 10px 0; color: #94a3b8; font-size: 14px;">Ready to place your bet? Click below:</p>
              <a href="${data.betSlipLink}" style="color: #10b981; font-size: 16px; font-weight: bold; text-decoration: underline;">
                🎯 Place Bet Now
              </a>
            </div>
            ` : ''}
...
${data.betSlipLink ? `� PLACE YOUR BET: ${data.betSlipLink}
    ...
    const mailOptions = {
      ...
      html: `
        <div style="font-family: Arial, sans-serif; max-width: 700px; margin: 0 auto; background: #0f172a;">
          ...
          <div style="padding: 30px; color: #e2e8f0;">
            <p style="font-size: 18px; margin: 0 0 20px 0;">
              Hey <strong style="color: #60a5fa;">${firstName}</strong>! 👋
            </p>
            
            <p style="font-size: 16px; line-height: 1.6; margin: 0 0 25px 0;">
              Here are your <strong style="color: #3b82f6;">FREE picks</strong> for today. Good luck! 🍀
            </p>
            ...
            ${data.betSlipLink ? `
            <!-- Bet Slip Link -->
            <div style="text-align: center; margin: 20px 0; padding: 20px; background: rgba(59, 130, 246, 0.1); border-radius: 8px;">
              <p style="margin: 0 0 10px 0; color: #94a3b8; font-size: 14px;">Ready to place your bet? Click below:</p>
              <a href="${data.betSlipLink}" style="color: #3b82f6; font-size: 16px; font-weight: bold; text-decoration: underline;">
                🎯 Place Bet Now
              </a>
            </div>
            ` : ''}
            ...
            <div style="background: rgba(59, 130, 246, 0.1); border: 1px solid rgba(59, 130, 246, 0.3); border-radius: 12px; padding: 20px; margin: 25px 0;">
              <h3 style="color: #3b82f6; margin: 0 0 12px 0; font-size: 16px;">💡 Quick Tips</h3>
              <ul style="margin: 0; padding-left: 20px; line-height: 1.8; color: #94a3b8; font-size: 14px;">
                <li>Always bet responsibly within your limits</li>
                <li>Consider using a staking plan for better bankroll management</li>
                <li>Check team news before placing your bets</li>
...
Here are your FREE picks for today. Good luck! 🍀
...
© ${new Date().getFullYear()} SureOdds Analytics. Bet responsibly. 18+ only.
    ...
    await transporter.sendMail(mailOptions);
    console.log('✅ Free picks email sent to:', data.email);

  } catch (error) {
    console.error('❌ Free picks email error:', error);
    throw error; // Re-throw to handle in the API route
  }
}
